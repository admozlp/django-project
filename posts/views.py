...
class CreatePostView(SuccessMessageMixin,CreateView):
    ...
    model = Post
    success_message = "Post Başarıyla Oluşturuldu!"
    ...
    def form_valid(self, form):
        ...
        for tag in tags:
            ...
            if current_tag.count() < 1:
                ...
                exsists_tag = Tag.objects.get(slug=slugify(tag))
                form.instance.tag.add(exsists_tag)
...
class PostUpdateView(SuccessMessageMixin,UpdateView):
    ...
    success_message = "Post Başarıyla Güncellendi!"
    ...
    def get(self,request,*args,**kwargs):
        ...
        if self.object.user != request.user:
            return HttpResponseRedirect('/')# yetki.html dendiğinde url hatası
...
class PostDeleteView(SuccessMessageMixin,DeleteView):
    ...
    success_url = '/'
    success_message = "Post Başarıyla Silindi!"
